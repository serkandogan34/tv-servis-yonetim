                                    ...
                                    <div class="bg-white border border-slate-200 hover:border-slate-300 transition-all duration-300 rounded-2xl shadow-sm hover:shadow-md relative">
                                        ...
                                        <div class="px-3 py-1 border-b border-slate-100">
                                            <div class="text-center">
                                                ...
                                                <h3 class="text-3xl font-bold text-slate-800 mb-1">GENEL PIYASA SORUNLARI</h3>
                                        ...
                                        <div class="p-2 space-y-1">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-slate-800 text-lg mb-1">Guvenilir Usta Bulamama</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-slate-50 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-slate-800 text-lg mb-1">Fiyat Belirsizligi</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-slate-50 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-slate-800 text-lg mb-1">Iscilik Garantisi Eksikligi</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-slate-50 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-slate-800 text-lg mb-1">Odeme Guvensizligi</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-slate-50 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-slate-800 text-lg mb-1">Iletisim Sorunu</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-slate-50 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-slate-800 text-lg mb-1">Sigorta ve Koruma Eksikligi</div>
                                        ...
                                        <div class="flex items-start p-3 hover:bg-slate-50 transition-colors duration-200 border-t border-slate-100 mt-4 pt-4 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-slate-800 text-lg mb-1">Dolandiricilik Riski</div>
                                ...
                                <div class="relative">
                                    ...
                                    <div class="bg-gradient-to-br from-blue-900 to-blue-800 border border-blue-300 hover:border-blue-200 transition-all duration-300 rounded-2xl shadow-sm hover:shadow-md relative">
                                        ...
                                        <div class="px-3 py-1 border-b border-blue-700">
                                            <div class="text-center">
                                                <div class="flex items-center justify-center mb-1">
                                                    ...
                                                    <h3 class="text-3xl font-bold text-white">KORUMA</h3>
                                                </div>
                                        ...
                                        <div class="p-2 space-y-1 text-white">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-white text-lg mb-1">Dogrulanmis Uzmanlar</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-white/5 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-white text-lg mb-1">Sabika Kaydi Sorgulama</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-white/5 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-white text-lg mb-1">Para Iade Garantisi</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-white/5 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-white text-lg mb-1">Sigorta Korumasi</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-white/5 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-white text-lg mb-1">7/24 Izleme Sistemi</div>
                                        ...
                                        <div class="flex items-start p-4 hover:bg-white/5 transition-colors duration-200 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-white text-lg mb-1">Danismanlik Hizmeti</div>
                                        ...
                                        <div class="flex items-start p-3 hover:bg-white/5 transition-colors duration-200 border-t border-blue-700 mt-4 pt-4 rounded-xl">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-semibold text-white text-lg mb-1">Hukuki Koruma</div>
